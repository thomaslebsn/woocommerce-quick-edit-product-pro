...
(function ($) {
    ...
    window.fntQEPP.ProductListHandler = (function(){
        ...
        module.init = function(){
            ...
            postFilterElement.off('click','#button-just-import').on('click','#button-just-import',redirectPage);
            ...
            postFilterElement.off('click','#button-delete-all-temp-product').on('click','#button-delete-all-temp-product',redirectPage);
