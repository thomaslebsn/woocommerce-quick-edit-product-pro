 ...
 *
 * Custom to make option to add attribute to all product
 *
 * @custom_by FinalThemes
...
/**
 * WC_Admin_Attributes_Custom Class.
 */
class WC_Admin_Attributes_Custom {
	/**
	...
	private static function process_add_attribute() {
        ...
        /**
         * Custom code to add feature add this attribute to all product
         */
        if ( isset( $_POST['attribute_to_all_product'] ) ) {
            WC_Product_Custom::add_more_attributes_for_all_product( $wpdb->insert_id );
        }
	...
	public static function edit_attribute() {
		...
		<div class="wrap woocommerce">
			...
			<h1>
                <?php _e( 'Edit Attribute', 'woocommerce' );
                    $back_link = Fnt_QEPP::get_redirect_page_url( array( 'edit-attributes' => 1 ) );
                ?>
                <a href="<?php echo $back_link; ?>" class="page-title-action"><?php echo esc_html_x( '&laquo; Back to edit attributes page', 'fnt' ); ?></a>
            </h1>
			...
			<?php
				...
				<form action="<?php echo Fnt_QEPP::get_redirect_page_url( array( 'edit-attributes' => 1 ) );?>&amp;edit=<?php echo absint( $edit ); ?>" method="post">
	...
	public static function add_attribute() {
		...
		<div class="wrap woocommerce">
			<div class="icon32 icon32-attributes" id="icon-woocommerce"><br/></div>
			<h1>
                <?php _e( 'Attributes', 'woocommerce' );
                    $back_link = Fnt_QEPP::get_redirect_page_url();
                ?>
                <a href="<?php echo $back_link; ?>" class="page-title-action"><?php echo esc_html_x( '&laquo; Back to edit product page', 'fnt' ); ?></a>
            </h1>
			<br class="clear" />
										...
										foreach ( $attribute_taxonomies as $tax ) :
											?><tr>
												...
												<td>
													...
													<div class="row-actions"><span class="edit"><a href="<?php echo esc_url( add_query_arg( 'edit', $tax->attribute_id, Fnt_QEPP::get_redirect_page_url( array( 'edit-attributes' => 1 ) ) ) ); ?>"><?php _e( 'Edit', 'woocommerce' ); ?></a> | </span><span class="delete"><a class="delete" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'delete', $tax->attribute_id, Fnt_QEPP::get_redirect_page_url( array( 'edit-attributes' => 1 ) ) ), 'woocommerce-delete-attribute_' . $tax->attribute_id ) ); ?>"><?php _e( 'Delete', 'woocommerce' ); ?></a></span></div>
												</td>
				...
				<div id="col-left">
					<div class="col-wrap">
						<div class="form-wrap">
							...
							<form action="<?php echo Fnt_QEPP::get_redirect_page_url( array( 'edit-attributes' => 1 ) );?>" method="post">
                                ...
                                <div class="form-field">
                                    <label for="attribute_to_all_product"><input name="attribute_to_all_product" id="attribute_to_all_product" type="checkbox" value="1" /> <?php _e( 'Add To All Product?', 'woocommerce' ); ?></label>

                                    <p class="description"><?php _e( 'Enable this if you want this attribute was added to all product.', 'woocommerce' ); ?></p>
                                </div>
